...
/* City having the best customers ! We would like to throw a promotional Music Festival in the city we made the most money. 
   query returns one city that has the highest sum of invoice totals. 
   It Returns both the city name & sum of all invoice totals */
...
/* Best customer? The customer who has spent the most money will be declared the best customer. 
   Query returns the person who has spent the most money.*/
